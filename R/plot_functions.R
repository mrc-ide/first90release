...
plot_pjnz_prv <- function(pjnz_summary, yr_pred = 2021) {
...
## -- UPDATE HERE --
## * update yr_pred to current year
plot_pjnz_inc <- function(pjnz_summary, yr_pred = 2021) {
...
## -- UPDATE HERE --
## * update yr_pred to current year
plot_pjnz_pop <- function(pjnz_summary, yr_pred = 2021) {
...
## -- UPDATE HERE --
## * update yr_pred to current year
plot_pjnz_plhiv <- function(pjnz_summary, yr_pred = 2021) {
...
## -- UPDATE HERE --
## * update yr_pred to current year
plot_input_tot <- function(prgdat, fp, yr_pred = 2021) {
    start <- fp$ss$proj_start
    mod <- simmod(fp)
...
## -- UPDATE HERE --
## * update yr_pred to current year
plot_input_totpos <- function(prgdat, fp, yr_pred = 2021) {
    start <- fp$ss$proj_start
    mod <- simmod(fp)
...
## -- UPDATE HERE --
## * update yr_pred to current year
plot_input_anctot <- function(prgdat, fp, yr_pred = 2021) {
...
## * update label to current year
                   'RR re-testing: PLHIV aware (not ART) 2021', 
