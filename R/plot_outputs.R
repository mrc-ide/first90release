...
plot_out_nbtest <- function(mod, fp, likdat, cnt, simul = NULL, yr_pred = 2023,
                            plot_title = TRUE) {
...
## -- UPDATE HERE --
## * update yr_pred to current year
plot_out_nbtest_sex <- function(mod, fp, likdat, cnt, simul = NULL, yr_pred = 2023) {
...
## -- UPDATE HERE --
## * update yr_pred to current year
plot_out_nbpostest <- function(mod, fp, likdat, cnt, simul = NULL, yr_pred = 2023,
                               plot_title = TRUE) {
  # if fitting with HTS program data stratified by sex, we add both sex back
  ld <- likdat$hts
  if (!is.null(ld)) {
...
## -- UPDATE HERE --
## * update yr_pred to current year
plot_out_nbpostest_sex <- function(mod, fp, likdat, cnt, simul = NULL, yr_pred = 2023) {
...
plot_out_evertestneg <- function(mod, fp, likdat, cnt, survey_hts, out_evertest,
                                 simul = NULL, plot_legend = TRUE, yr_pred = 2023) {
...
tab_out_evertest <- function(mod, fp, age_grp = '15-49', gender = 'both',
                             hiv = 'all', year_range = c(2010, 2023),
...
tab_out_aware <- function(mod, fp, age_grp = '15-49', gender = 'both',
                          year_range = c(2010, 2023), simul = NULL,
                          end_year = TRUE) {
...
tab_out_nbaware <- function(mod, fp, age_grp = '15-49',
                            gender = 'both', year_range = c(2010, 2023),
                            end_year = TRUE) {
...
## -- UPDATE HERE --
## * update year_range to include current year
tab_out_pregprev <- function(mod, fp, year_range = c(2010, 2023),
                             end_year = TRUE) {
